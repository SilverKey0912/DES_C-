...
{
     string pt, key;
    cout<<"Nhap van ban can ma hoa(he hex): ";
    cin>>pt;
    cout<<"Nhap khoa K(he hex): ";
    cin>>key;
    key = hex2bin(key);
...
long mul_inv(long a, long b) //a^-1 mod b
{
	long b0 = b, t, q;
	long x0 = 0, x1 = 1;
	if (b == 1) return 1;
...
void chiakhoa()
{
	...
	cout<<endl;
	cout<<"\n Nhap bi mat t-1 pha tu trong Zp";
	for(int j=1; j<t; j++)
	{
		cout<<"\n a["<<j<<"]="; cin>>a[j];
	}
...
int main()
{
   system("cls");
	...
	do
	{
		...
		cout<<"\n ===============================================\n";
		cout<<"\n 1. DES";
		cout<<"\n 2. Chia se khoa bi mat";
		cout<<"\n 3. Khoi phuc khoa bang phuong phap dung cong thuc noi suy Langrangre.";
		cout<<"\n 0. Thoat khoi chuong trinh.";
		cout<<"\n Moi chon:"; cin>>chon;
		switch(chon)
		{
		    case 1: system("cls"); mahoa();break;
			case 2: system("cls"); chiakhoa(); break;
			case 3: system("cls"); congthuckhoiphuckhoa(); break;
		}
	}while(chon!=0);
	return 1;
}
